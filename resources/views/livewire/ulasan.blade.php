<div>
    <div class="flex flex-col gap-3 fixed right-5 top-24" wire:ignore.self>
        <div id="alertNotif" wire:ignore.self
            class="pointer-events-none opacity-0 translate-x-5 rounded-md bg-green-500 p-3 font-semibold text-white transition-all duration-300">
            Terima Kasih atas Ulasan anda
        </div>
    </div>
    <div class="my-14 grid w-full place-items-center gap-3 p-3">
        <form wire:submit.prevent='tambahKomentar' data-aos="fade-up" data-aos-duration="500" data-aos-offset="230" wire:ignore.self
