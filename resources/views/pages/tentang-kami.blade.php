...
@section('pages')
    ...
    <main>
        ...
        <div class="mt-2 grid w-full place-items-center gap-3 p-3">
            ...
            <figure
                class="max-w-72 flex flex-col p-3 md:max-w-3xl md:flex-row-reverse md:items-center md:justify-evenly md:gap-5 lg:w-full lg:max-w-5xl">
                ...
                <figcaption class="mt-4 flex flex-col gap-4 md:h-full md:gap-5">
                    ...
                    <p class="text-[10px] md:w-80 md:text-sm">Sebuah website proyek Pariwisata yang di kerjakan oleh sebuah
        ...
        <div class="my-20">
            ...
            <div class="flex w-full flex-col items-center gap-5 sm:gap-2 md:gap-7 py-10 sm:flex-row sm:justify-center sm:gap-7 lg:gap-14">
                <div class="order-2 sm:order-1 size-52 group hover:mb-20 sm:hover:mb-0 transition-all relative rounded border border-black/10 bg-[#8DA7A5] shadow-md" data-aos="fade-up" data-aos-duration="500" data-aos-offset="230">
                    <img src="{{ asset('assets/img/team/alim.png') }}" alt=""
                        class="absolute bottom-0 z-10 origin-bottom transform-gpu transition-transform group-hover:translate-x-4 group-hover:scale-[1.15] w-36 left-7">
                    <div
                        class="absolute -bottom-[76px] left-1/2 flex w-max -translate-x-1/2 flex-col text-center opacity-0 transition-all group-hover:opacity-100">
                    ...
                    <div
                        ...
                        <a href="#">
                            <span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    class="text-[#264240] hover:text-black transition duration-300" viewBox="0 0 432 416">
                ...
                <div class="order-1 sm:order-2 size-52 group hover:mb-14 sm:hover:mb-0 transition-all relative rounded border border-black/10 bg-[#8DA7A5] shadow-md" data-aos="fade-up" data-aos-duration="500" data-aos-offset="230">
                    ...
                    <div
                        class="absolute -bottom-12 left-1/2 flex w-max -translate-x-1/2 flex-col text-center opacity-0 transition-all group-hover:opacity-100">
                ...
                <div class="order-3 size-52 group hover:mb-14 sm:hover:mb-0 transition-all relative rounded border border-black/10 bg-[#8DA7A5] shadow-md" data-aos="fade-up" data-aos-duration="500" data-aos-offset="230">
                    <img src="{{ asset('assets/img/team/fadil.png') }}" alt=""
                        class="absolute bottom-0 z-10 origin-bottom transform-gpu transition-transform group-hover:translate-x-4 group-hover:scale-[1.15] w-48 left-2">
                    <div
